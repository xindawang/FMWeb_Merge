 ...
 *
 */
public class svm_scale_for_train
{
    ...
    private void output(int index, double value)
    {
        ...
        if(value != 0)
        {
            ...
            stringBuffer.append(index).append(":").append(value).append(" ");
    ...
    private void run(String []argv) throws IOException
    {
        ...
        fp.close();
        if (save_file != null) {
            fWriter = new PrintWriter(new FileOutputStream(save_file));
        }
        fWriter.print(stringBuffer);
        fWriter.flush();
        fWriter.close();
    }
    ...
    {
        svm_scale_for_train s = new svm_scale_for_train();
        s.run(argv);
    }
}